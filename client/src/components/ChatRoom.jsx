      ...
      {!isLoggedIn ? (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-purple-800 text-white dark:text-white p-4">
          <div className="flex justify-center items-center w-full h-32 bg-opacity-90 shadow-lg mb-8">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-wide text-center text-white">
          ...
          <div className="flex flex-col gap-8 items-center bg-white bg-opacity-10 p-6 md:p-10 rounded-3xl shadow-2xl w-full max-w-lg dark:bg-gray-800 dark:bg-opacity-90">
            <h2 className="text-lg md:text-xl font-semibold tracking-wide text-center text-white">
              Join a Room to Start Chatting
            </h2>

            <div className="flex flex-col gap-4 w-full">
              <input
                className="w-full border border-blue-300 p-3 rounded-lg bg-opacity-80 bg-white text-gray-900 placeholder-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
                type="text"
          ...
          <div className="w-full h-[calc(100vh-200px)] border border-gray-300 bg-opacity-20 rounded-lg shadow-lg bg-white dark:bg-gray-800 overflow-hidden flex flex-col">
              ...
              {messageList.map((val, key) => (
                <div
                  ...
                  className={`p-3 rounded-lg ${
                    val.author === userName
                      ? "bg-gradient-to-br from-blue-500 to-purple-800 self-end text-white"
                      : "bg-gradient-to-br from-gray-800 to-purple-800 dark:bg-gray-700 dark:text-white"
                  } max-w-[70%]`}
                >
            ...
            <div className="flex gap-4 p-4 border-t border-gray-300 dark:border-gray-600">
              <input
                ...
                className="flex-1 p-2 border border-gray-300 rounded-md dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                onClick={sendMessage}
