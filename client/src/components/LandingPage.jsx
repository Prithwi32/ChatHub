...
export default function LandingPage() {
  ...
  return (
    <>
    <div className="bg-gradient-to-br from-[#C9E1CD] to-[#4ABEBD] min-h-[600px] flex items-center justify-center text-black">
        <div className="w-[50%]">
            ...
            <button className="mt-6 px-6 py-3 bg-gradient-to-br from-[#fc9f88] to-[#EA6A49] hover:from-[#EA6A49] hover:to-[#fc9f88] text-white rounded-lg"
