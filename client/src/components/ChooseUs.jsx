...
import FastPerformanceImage from '../images/Fast-Performance.png';
        ...
        <>
            <div data-aos="fade-down" className="bg-gradient-to-br from-[#C9E1CD] to-[#4ABEBD] text-black min-h-[600px] p-[3rem]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 m-[1rem]">
                    ...
                    <div data-aos="fade-up" className="bg-white rounded-[2rem] p-[2rem] text-center">
                        <img className='m-auto w-[200px]' src={FastPerformanceImage} alt="Fast Performance" />
