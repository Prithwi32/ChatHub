...
export default function CTA() {
  ...
  return (
    <>
      ...
      >
        <h3 className="text-center m-[3rem] mt-[5rem] underline text-[#EA6A49] dark:text-[#FC9F88] text-4xl font-bold">
          Call-to-Action (CTA)
        </h3>
        <div
        ...
        >
          <h6 className="dark:text-gray-200">
            Join thousands of users already enjoying secure and instant messaging.
          </h6>
          <button
